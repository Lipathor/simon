...
function simon(db, server){
    ...
    simon.prototype.get = function(collection,id,fields,sort,pagination,callback) {
        id = id || {};
        fields = fields || {};
        sort = sort || {};
    ...
    simon.prototype.post = function(collection,docs,callback) {
        this.client.open(function(err,p_client){
            if(err) throw err;
            p_client.collection(collection,function(err,collection){
                if(err) throw err;
    ...
    simon.prototype.delete = function(collection,id,callback){
        id = id || '-';
        this.client.open(function(err,p_client){
            if(err) throw err;
    ...
    simon.prototype.put = function(collection,id,doc,callback) {
        this.client.open(function(err,p_client){
            if(err) throw err;
            p_client.collection(collection,function(err,collection){
                if(err) throw err;
